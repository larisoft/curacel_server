var config = {
  couchDbServer: 'ec2-52-33-118-77.us-west-2.compute.amazonaws.com',
  couchDbPort: '5984',
  couchDbUseSsl: false,
...
config.couchDbURL = config.couchAuthDbURL;
config.searchURL = 'http://localhost:9200'; // ELASTIC SEARCH URL
config.webDir = __dirname + '/public';
config.serverInfo = 'Server Information to display to users when viewing about Curacel';
